...
CREATE TABLE `video_kategorija` (
  `IdVid` int NOT NULL,
  `IdKat` int NOT NULL,
  `Polje` varchar(45) NOT NULL,
  PRIMARY KEY (`IdVid`,`IdKat`),
  KEY `FK_IdKat_idx` (`IdKat`),
  CONSTRAINT `FK_IdKat` FOREIGN KEY (`IdKat`) REFERENCES `kategorija` (`IdKat`) ON UPDATE CASCADE,
  CONSTRAINT `FK_IdVid` FOREIGN KEY (`IdVid`) REFERENCES `video` (`IdVid`) ON DELETE CASCADE ON UPDATE RESTRICT
...
INSERT INTO `video_kategorija` VALUES (2,1,'polje'),(2,2,'polje'),(6,3,'polje');
