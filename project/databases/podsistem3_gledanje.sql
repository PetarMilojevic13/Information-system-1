...
CREATE TABLE `gledanje` (
  ...
  KEY `FK_IdVid_idx` (`Video`),
  CONSTRAINT `FK_IdKoris` FOREIGN KEY (`Korisnik`) REFERENCES `korisnik` (`IdKor`),
  CONSTRAINT `FK_IdVid` FOREIGN KEY (`Video`) REFERENCES `video` (`IdVid`) ON DELETE CASCADE
...
INSERT INTO `gledanje` VALUES (1,5,1,'2019-05-05','19:19:19',150,890),(2,6,1,'2019-05-06','20:20:20',150,900),(3,6,2,'2023-04-04','12:12:12',700,900);
